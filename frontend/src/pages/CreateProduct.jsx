...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!thumbnailFile) return toast.error('Please upload a store cover image');
    ...
    try {
      ...
      toast.success('Product created and all files uploaded successfully!');
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' }}>
            ...
            <div className="form-group">
              <label className="form-label">
                <Image size={14} /> Store Cover Image (Thumbnail)
              </label>
              <div style={{
                ...
                {thumbnailFile ? (
                  ...
                  <>
                    ...
                    <div>
                      <p style={{ fontSize: 'var(--font-size-sm)', fontWeight: 600 }}>Select Cover Image</p>
            ...
            <div className="form-group">
              <label className="form-label">
                <Upload size={14} style={{ marginRight: '6px' }} /> Product File (ZIP, PDF, DOCX, etc.)
              </label>
              <div style={{
                border: '2px dashed var(--color-surface-border)',
                borderRadius: 'var(--radius-xl)',
                ...
                {productFile ? (
                  ...
                  <>
                    <Upload size={24} style={{ color: 'var(--color-text-muted)' }} />
                    <div>
                      <p style={{ fontSize: 'var(--font-size-sm)', fontWeight: 600 }}>Select Product File</p>
                      <p style={{ fontSize: 'var(--font-size-xs)', color: 'var(--color-text-muted)', marginTop: '2px' }}>
            ...
            <button type="submit" className="btn btn-primary btn-lg" style={{ marginTop: 'var(--space-2)' }} disabled={submitting}>
              <Save size={18} />
              {submitting ? 'Creating Product & Uploading...' : 'Create & List Product'}
            </button>
          </form>
        </div>
      </div>
